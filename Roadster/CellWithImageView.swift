...
class CellWithImageView: UITableViewCell {
    ...
    func configureCell(forState state: (String, String)) {
        ...
        if let image = UIImage(named: stateName.lowercased())?.resizeImage(CGSize(width: 62.0, height:
            62.0)){
        ...
        if highway.contains("RT-"){
            ...
            if highwayNameComponents.count > 1 {
                ...
                if let image = UIImage(named: highwayName){
                    ...
                    let resizedimage = image.resizeImage(CGSize(width: 62.0, height:
                        62.0)).withRenderingMode(.alwaysOriginal)
            ...
            if stateAbbreviation.uppercased() == "MI" && highway.contains("M-"){
            ...
            if stateAbbreviation.uppercased() == "NJ" && highway.contains("New Jersey Turnpike"){
                
                let highwayName = "NJ-" + highway
            ...
            if stateAbbreviation.uppercased() == "NJ" && highway.contains("Atlantic City Expressway"){
            ...
            if stateAbbreviation.uppercased() == "NJ" && highway.contains("Garden State Parkway"){
            ...
            if stateAbbreviation.uppercased() == "NY" && highway.contains("NY-"){
                
                let highwayName = "NY-" + highway
            ...
            if stateAbbreviation.uppercased() == "NY" && highway.contains("Taconic State Parkway"){
            ...
            if stateAbbreviation.uppercased() == "NY" && highway.contains("Long Island Expressway"){
            ...
            if stateAbbreviation.uppercased() == "NY" && highway.contains("NY Thruway"){
            ...
            if stateAbbreviation.uppercased() == "NC" && highway.contains("NC-"){
                
                let highwayName = "NC-" + highway
            ...
            if stateAbbreviation.uppercased() == "ND" && highway.contains("ND-"){
                
                let highwayName = "ND-" + highway
            ...
            if stateAbbreviation.uppercased() == "OH" && highway.contains("SR-"){
                
                let highwayName = "OH-" + highway
            ...
            if stateAbbreviation.uppercased() == "SD" && highway.contains("SR-"){
                
                let highwayName = "SD-" + highway
            ...
            if stateAbbreviation.uppercased() == "TX" && highway.contains("SH-") {
