...
class BusinessDetailChildTableViewController: UITableViewController {
    ...
    func constructHoursString(weekDayHours: [String: AnyObject]?) -> String{
        ...
        if let startTime = weekDayHours["start"], let endTime = weekDayHours["end"]{
            ...
            if let  startTimeString = startTime as? String{
                ...
                let hour = String(startTimeString[startTimeString.startIndex]).appending(String(startTimeString[startTimeString.index(startTimeString.startIndex, offsetBy: 1)]))
                
                let minute = String(startTimeString[startTimeString.index(startTimeString.startIndex, offsetBy: 2)]).appending(String(startTimeString[startTimeString.index(startTimeString.startIndex, offsetBy: 3)]))
            ...
            if let endTimeString = endTime as? String{ // This code parses the business hours provided by Yelp in text format
                
                let endTimeInt = Int(endTimeString)
                
                let hour = String(endTimeString[endTimeString.startIndex]).appending(String(endTimeString[endTimeString.index(endTimeString.startIndex, offsetBy: 1)]))
                
                let minute = String(endTimeString[endTimeString.index(endTimeString.startIndex, offsetBy: 2)]).appending(String(endTimeString[endTimeString.index(endTimeString.startIndex, offsetBy: 3)]))
    ...
    func getEstimatedTravelTime(with userLocation: CLLocation){
    ...
    func addToFavorite(){
        ...
        let  favoriteBusiness: HistoryYelpBusiness = HistoryYelpBusiness(businessIdentifier: businessID,
                                                                         name: businessName, rating: rating,
...
extension BusinessDetailChildTableViewController{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            cell.backgroundColor = UIColor.clear
            if indexPath.row < comments.count{ // Checking if number of static cells are in sync with number of comments in comments array
